...
# --- Tasks for Buddy ---
buddy.add_task(Task(name="Morning Walk", description="30-min walk around the block",          due_time="7:00 AM",  duration=30, priority=1, category="walk"))
buddy.add_task(Task(name="Breakfast",    description="One cup of dry kibble",                  due_time="8:00 AM",  duration=10, priority=2, category="feed"))
...
# --- Tasks for Whiskers ---
whiskers.add_task(Task(name="Medication", description="Half-pill hidden in wet food",          due_time="8:30 AM",  duration=5,  priority=1, category="medication"))
